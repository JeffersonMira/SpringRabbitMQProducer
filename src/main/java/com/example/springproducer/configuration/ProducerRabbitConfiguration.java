...
public class ProducerRabbitConfiguration {
    ...
    //Caso tenha algum problema no entrega da mensagem, o MQ vai mandar para essa outra fila a mensagem com erro.
    //assim podemos tratar a mensagem e endereçar ela da melhor forma.
    @Bean
    Queue deadLetter(){
    ...
    @Bean
    Queue queue(){
        //precisa adicionar isso para definir que essa vai ser a deadletter
